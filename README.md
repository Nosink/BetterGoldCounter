...
- Configurable label: font size, dynamic or static width, backdrop toggle.
- Position controls: lock/unlock and save exact screen coordinates.
- Optional fade: set fade-in/out opacity and duration; smooth hover transitions.
- Localization: English (enUS) and Spanish (esES/esMX).
