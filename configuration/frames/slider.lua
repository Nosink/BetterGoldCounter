...
function ns.builder.CreateSlider(self, text, key)
    ...
    slider:SetValue(DB:GetDB()[key] or 0)
    ...
    valueText:SetText(string.format("%.2f", DB:GetDB()[key] or "0.00"))
    ...
    slider.FetchFromDB = function(self)
        self:SetValue(DB:GetDB()[key] or 0)
        updateValueLabel(DB:GetDB()[key] or 0)
    end
